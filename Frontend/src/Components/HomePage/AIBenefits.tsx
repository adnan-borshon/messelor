...
function AIBenefits() {
     const aiBenefitsData = [
  {
    ...
    desc: "Predict monthly expenses with trend analysis",
  },
  {
    icon: FaExclamationTriangle,
    title: "Anomaly Detection",
    desc: "Smart alerts for unusual expense patterns",
  },
  {
    icon: FaBell,
    title: "Smart Reminders",
    desc: "Never forget to log meals with AI reminders",
  },
  {
    icon: FaChartPie,
    title: "Nutrition Dashboard",
    desc: "Track nutritional intake and health metrics",
  },
];
  return (
     <section className="ai-benefits py-16 bg-gradient-to-r from-[#6a11cb] to-[#2575fc] text-white">
